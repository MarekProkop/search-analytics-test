...
![](search-analytics-test_files/figure-html/all_combos_charts-1.png)<!-- -->
...
(URLs of pages are anonymized and only the first few rows of 150 are listed.)
...
(URLs of pages are anonymized and only the first few rows of 170 are listed.)
...
(URLs of pages are anonymized and only the first few rows out of 170 are listed.)

Differences in both impressions and clicks are not dependent on base values and seem to be random.

![](search-analytics-test_files/figure-html/diff_chart_impressions-1.png)<!-- -->![](search-analytics-test_files/figure-html/diff_chart_impressions-2.png)<!-- -->![](search-analytics-test_files/figure-html/diff_chart_impressions-3.png)<!-- -->![](search-analytics-test_files/figure-html/diff_chart_impressions-4.png)<!-- -->
